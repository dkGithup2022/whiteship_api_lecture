...
.request-headers
include::{snippets}/create-events/request-headers.adoc[]

.request-fields
include::{snippets}/create-events/response-fields.adoc[]

.http-request
include::{snippets}/create-events/http-request.adoc[]

=== 응답

.response-headers
include::{snippets}/create-events/response-headers.adoc[]

.response-fields
include::{snippets}/create-events/response-fields.adoc[]

.response-links
include::{snippets}/create-events/links.adoc[]

.http-response
include::{snippets}/create-events/http-response.adoc[]
